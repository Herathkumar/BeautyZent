...
const demos = [
  ...
  {
    step: "3",
    href: `/display/${slug}/lounge`,
    external: false,
    title: "Lounge display",
    subtitle: "Waiting-room TV — first names only",
    hint: "Today’s appointments by stylist chair",
    accent: "from-[#2a3f3a] to-[#1c1714]",
  },
  {
    step: "3a",
    href: `/display/${slug}/scheduler`,
    external: false,
    title: "Scheduler display",
    subtitle: "Day timeline TV — schedule columns",
    hint: "Full-day view for a second store screen",
    accent: "from-[#1e2a3f] to-[#10141a]",
  },
  {
    step: "3b",
    ...
    subtitle: "Front desk — check-in and walk-ins",
    hint: "Full names · waitlist · New Booking",
