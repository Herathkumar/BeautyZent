...
export default function StylistStoreDisplayPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (!cancelled) setSlug(data.stylist?.salon?.slug || null);
    })();
    return () => {
      cancelled = true;
    };
  ...
  return (
    <main className="space-y-4" data-testid="stylist-store-display">
