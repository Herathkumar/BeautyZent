...
/** Lightweight tablet PIN manager for Profile — no floor board. */
export function TabletPinCard() {
    ...
    >
      ...
      <div className="mt-4 border-t border-[#7d6154]/15 pt-4">
        ...
        <p className="mt-2 text-sm text-[#6b5b52]">
          {pinSet
            ? "Anyone opening the tablet URL must enter the PIN. Refreshing or reopening asks for the PIN again."
