...
export function LotusMark({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 48 48" fill="none" aria-hidden>
      <path
        d="M24 42c-2.5-4.5-8-10.5-8-18 0-5 2.8-8 8-12 5.2 4 8 7 8 12 0 7.5-5.5 13.5-8 18Z"
        fill="#c19a6b"
        opacity="0.95"
      />
      <path
        d="M24 42c-6-3.5-14-10-14-18.5C10 16 15 12 24 8c9 4 14 8 14 15.5C38 32 30 38.5 24 42Z"
        fill="#c19a6b"
        opacity="0.55"
      />
      <path
        d="M24 40c1.8-6 4.5-10.5 8.5-14.5 2.2 3.2 3.5 6.2 3.5 9.5 0 4.5-4.5 8-12 5Z"
        fill="#d4b089"
        opacity="0.85"
      />
      <path
        d="M24 40c-1.8-6-4.5-10.5-8.5-14.5C13.3 28.7 12 31.7 12 35c0 4.5 4.5 8 12 5Z"
        fill="#d4b089"
        opacity="0.85"
      />
    </svg>
